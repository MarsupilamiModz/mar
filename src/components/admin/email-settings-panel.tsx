      ...
      <Card className="glass p-6 space-y-4">
        <div className="flex flex-wrap items-center justify-between gap-3">
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Configure outbound email. Falls back to Resend if SMTP is disabled.
            </p>
          </div>
        ...
        >
          <label className="flex items-center gap-2 text-sm sm:col-span-2">
            <input type="checkbox" name="enabled" defaultChecked={settings.enabled} /> Enable SMTP
          </label>
          <Input name="smtpHost" defaultValue={settings.smtpHost} placeholder="SMTP Host" />
