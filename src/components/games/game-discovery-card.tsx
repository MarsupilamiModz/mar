...
export const GameDiscoveryCard = memo(function GameDiscoveryCard({
  ...
  return (
    ...
    >
      <Card className="relative h-full overflow-hidden rounded-2xl border-border/50 bg-background/40 transition-[transform,box-shadow,border-color] duration-200 hover:-translate-y-0.5 hover:border-neon-purple/50 hover:shadow-[0_0_32px_rgba(168,85,247,0.2)] will-change-transform">
        ...
        <div className="space-y-3 p-4">
          <h3 className="text-lg font-bold leading-tight tracking-tight group-hover:text-neon-purple transition-colors duration-150 line-clamp-2">
            {game.name}
          </h3>
